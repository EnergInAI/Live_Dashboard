...
const Dashboard: React.FC = () => {
  ...
  // Single 'totals' state to hold all daily values
  ...
  // useEffect for persisting URL params
  useEffect(() => {
    if (urlDeviceId) {
  ...
  // useEffect for access validation
  useEffect(() => {
    if (!deviceId || !token) {
  ...
  // useEffect for fetching data and updating totals
  useEffect(() => {
